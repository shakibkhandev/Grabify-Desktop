...
export default function InstagramContentScreen() {
  ...
  return (
    <div>
          <ScreenContent videosList={videosList} title="Instagram" onSearchQueryChange={handleSearchQueryChange} searchQuery={searchQuery} onSubmit={handleSubmit} onQualityChange={handleQualityChange} quality={quality} qualityList={qualityList} onDownloadClick={handleDownloadClick} />
    </div>
  )
}
